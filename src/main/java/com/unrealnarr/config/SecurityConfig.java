...
public class SecurityConfig {
    ...
    @Bean
    public AuthenticationManager customAuthenticationManager(HttpSecurity http, PasswordEncoder passwordEncoder, UserDetailsService userDetailsService) throws Exception {
